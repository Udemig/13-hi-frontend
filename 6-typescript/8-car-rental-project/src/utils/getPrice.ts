...
export const getPrice = (car: Car): number => {
  ...
  const premiumBrands = ["BMW", "Mercedes-Benz", "Audi", "Lexus", "Porsche", "Jaguar", "Land Rover"];
  const luxuryBrands = ["Ferrari", "Lamborghini", "Bentley", "Rolls-Royce", "Maserati"];
  ...
  if (car.fueltype.includes("Electric") || car.fueltype.includes("Electricity")) {
