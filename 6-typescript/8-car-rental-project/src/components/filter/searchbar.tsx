...
const SearchBar: FC = () => {
  ...
  const options = useMemo(
    () => [{ label: "Tümü", value: null }, ...makes.map((make) => ({ label: make, value: make }))],
    []
  );
  ...
  return (
    <form onSubmit={handleSubmit} className="searchbar flex gap-4 items-start justify-center">
      ...
      <div className="searchbar-item items-end">
        <div className="w-full flex flex-col z-[49]">
          ...
          <ReactSelect
            ...
            value={make ? { label: make, value: make } : { label: "Tümü", value: null }}
          />
        </div>
      ...
      <div className="searchbar-item items-start flex flex-col">
        <label className="text-whhite font-semibold mb-2 text-sm">Model</label>

        <div className="w-full flex items-center">
          <div className="relative flex-1">
            <img src="/model-icon.png" className="size-6 absolute left-4 top-1/2 -translate-y-1/2 z-1" />
