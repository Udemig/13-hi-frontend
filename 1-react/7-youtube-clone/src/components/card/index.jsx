    ...
    return (
      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-2 md:gap-4">
          <h3 className="line-clamp-2 leading-tight text-base @lg:text-lg">{video.title}</h3>

          {video.viewCount && (
            <div className="flex items-center gap-1 text-xs @md:text-sm text-[#aaaaaa]">
              <span className="line-clamp-1">
                {millify(video.viewCount, { units: ["", "B", "Mn", "Mr", "Tr"] })}{" "}
          ...
          <p className="text-sm text-[#aaaaaa] hover:text-white">{video.channelTitle}</p>
