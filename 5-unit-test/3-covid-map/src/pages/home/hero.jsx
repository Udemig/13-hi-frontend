    ...
    <div className="bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white relative overflow-hidden">
      ...
      <div className="container py-10 pb-16 md:pt-[100px] md:pb-[120px] grid md:grid-cols-2 gap-10 relative z-10">
        <div className="flex flex-col gap-6 md:gap-10 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-pink-100 to-purple-200 bg-clip-text text-transparent leading-tight">
          ...
          <div className="flex gap-5">
            <button className="hero-btn hover:brightness-110">
              Nasıl Korunulur
            </button>
            <button className="hero-btn bg-transparent border-2 border-white/30 hover:bg-white hover:text-blue-900 backdrop-blur-sm">
              Doktor Bul
            </button>
          </div>
        </div>
